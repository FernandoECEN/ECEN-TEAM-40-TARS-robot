...
{
  new (message_memory) robot_interfaces::msg::ControllerCommand(_init);
}

void ControllerCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robot_interfaces::msg::ControllerCommand *>(message_memory);
  typed_message->~ControllerCommand();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember ControllerCommand_message_member_array[3] = {
  {
    "motor_id",  // name
    ...
    offsetof(robot_interfaces::msg::ControllerCommand, motor_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_interfaces::msg::ControllerCommand, motor_direction),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_interfaces::msg::ControllerCommand, motor_speed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ControllerCommand_message_members = {
  ...
  3,  // number of fields
  sizeof(robot_interfaces::msg::ControllerCommand),
...
{
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::ControllerCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_interfaces, msg, ControllerCommand)() {
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::ControllerCommand_message_type_support_handle;
}
