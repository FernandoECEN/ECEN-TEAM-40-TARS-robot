...
bool robot_interfaces__msg__vision_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // distance_array
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      float * dest = ros_message->distance_array.data;
...
PyObject * robot_interfaces__msg__vision_data__convert_to_py(void * raw_ros_message)
{
  ...
  {  // distance_array
    ...
    if (ros_message->distance_array.size > 0) {
      ...
      float * src = &(ros_message->distance_array.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->distance_array.size * sizeof(float));
      assert(data != NULL);
