...
bool robot_interfaces__msg__vision_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // distance_array
    PyObject * field = PyObject_GetAttrString(_pymsg, "distance_array");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->distance_array.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'distance_array'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of VisionData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_interfaces.msg._vision_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VisionData");
  ...
  {  // distance_array
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "distance_array");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->distance_array.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->distance_array.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->distance_array.size * sizeof(double));
      assert(data != NULL);
