...
{
  new (message_memory) robot_interfaces::msg::MotorFeedback(_init);
}

void MotorFeedback_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robot_interfaces::msg::MotorFeedback *>(message_memory);
  typed_message->~MotorFeedback();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorFeedback_message_member_array[2] = {
  {
    "feedback1",  // name
    ...
    offsetof(robot_interfaces::msg::MotorFeedback, feedback1),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_interfaces::msg::MotorFeedback, feedback2),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorFeedback_message_members = {
  ...
  2,  // number of fields
  sizeof(robot_interfaces::msg::MotorFeedback),
...
{
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::MotorFeedback_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_interfaces, msg, MotorFeedback)() {
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::MotorFeedback_message_type_support_handle;
}
